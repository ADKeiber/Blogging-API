...
public class TagController {
	...
	@Operation(summary = "Create a new Tag", description = "Creates a new tag by taking in a JSON Tag Object in the request body. If required fields are blank/null inside of the request body an API Error will be returned. Fields Required: value", responses = {
	...
	@Operation(summary = "Get all tags", description = "Returns all Tags inside of a JSON list", responses = {
			@ApiResponse(description = "Success", responseCode = "200", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Tag.class)), examples = {
					@ExampleObject(value = "[\n" + "	{\n"
							+ "		\"id\":\"1024c237-0938-43bc-9c4e-f533ae5a22e6\",\n"
							+ "		\"value\":\"Test tag12345\",\n" + "	},\n" + "	{\n"
	...
	@Operation(summary = "Update a Tag by ID", description = "Updates a Tag by taking in a JSON Tag Object in the request body and an ID in the paramaters. If required fields are blank/null inside of the request body or no tag exists with given ID an API Error will be returned. Fields Required: value", responses = {
			@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = Tag.class), examples = {
					@ExampleObject(value = "{\n" + "	\"id\":\"1024c237-0938-43bc-9c4e-f533ae5a22e6\",\n"
							+ "	\"value\":\"Example Blog Tag\"\n" + "}") })),
			@ApiResponse(description = "Bad Request/ Missing Required Field", responseCode = "400", content = @Content(schema = @Schema(implementation = ApiError.class), examples = {
	...
	@Operation(summary = "Get a Tag by ID", description = "Retrieves a Tag by taking in an ID in the paramaters."
			+ "If no tag exists with the given ID an API Error will be returned, otherwise a JSON Tag is returned.", responses = {
					@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = Tag.class), examples = {
							@ExampleObject(value = "{\n" + "	\"id\":\"1024c237-0938-43bc-9c4e-f533ae5a22e6\",\n"
									+ "	\"value\":\"Example Blog Tag\"\n" + "}") })),
					@ApiResponse(description = "Bad Request/ No Tag found", responseCode = "404", content = @Content(schema = @Schema(implementation = ApiError.class), examples = {
	...
	@Operation(summary = "Get a Tag by Value", description = "Retrieves a Tag by taking in an ID in the paramaters. "
			+ "If no tag exists with given ID an API Error will be returned, otherwise a JSON Tag is returned.", responses = {
					@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = Tag.class), examples = {
							@ExampleObject(value = "{\n" + "	\"id\":\"1024c237-0938-43bc-9c4e-f533ae5a22e6\",\n"
									+ "	\"value\":\"Example Blog Tag\"\n" + "}") })),
					@ApiResponse(description = "Bad Request/ No Tag found", responseCode = "404", content = @Content(schema = @Schema(implementation = ApiError.class), examples = {
	...
	@Operation(summary = "Delete a Tag by ID", description = "Deletes a Tag by taking in an ID in the paramaters. "
			+ "If no tag exists with the given ID an API Error will be returned, otherwise the tag will be deleted.", responses = {
	...
	@Operation(summary = "Delete a Tag by Value", description = "Deletes a Tag by taking in an ID in the paramaters."
			+ "If no tag exists with given value an API Error will be returned, otherwise the tag will be deleted.", responses = {
					@ApiResponse(description = "Success", responseCode = "200", content = @Content(examples = {
							@ExampleObject(value = "") })),
					@ApiResponse(description = "Bad Request/ No Tag found", responseCode = "404", content = @Content(schema = @Schema(implementation = ApiError.class), examples = {
							@ExampleObject(value = "{\n" + "	\"apierror\":\n" + "	{\n"
